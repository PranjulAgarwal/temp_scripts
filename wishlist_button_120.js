...
const serverUrl = "http://4d2e456cbbf4.ngrok.io";
...
if (window.meta && (window.meta.page.pageType === "collection")){
    console.log(document.getElementsByClassName('heart_button_catalog'));
}
...
function renderHeartCatalog(){
    ...
    <button  id="heart_btn_product"  data-variant-id='{{ product.variants[0].id }}' class="button_wish_catalog">${icon_Btn_cata}</button>`
...
function render_heart(){
    ...
    document.getElementsByName("head").insertAdjacentHTML('afterend',wishlistUI);
