...
function changeButton(data,in_list){
    ...
    if(in_list){
        if(data.ButtonType=='1'){
            ...
            btn.innerHTML=`${data.LabelAftereButton}`;
        }
        if(data.ButtonType=='2'){
            btn.style.backgroundColor = `${data.ColorAfterButton}`;
            btn.innerHTML=`<i class="fa fa-heart" aria-hidden="true"></i>     ${data.LabelAftereButton}`;
        }
        ...
        if(data.ButtonType=='1'){
            ...
            btn.innerHTML=`${data.LabelBeforeeButton}`;
        }
        if(data.ButtonType=='2'){
            btn.style.backgroundColor = `${data.ColorBeforeButton}`;
            btn.innerHTML=`<i class="fa fa-heart-o" aria-hidden="true"></i>     ${data.LabelBeforeeButton}`;
        }
        if(data.ButtonType=='3'){
