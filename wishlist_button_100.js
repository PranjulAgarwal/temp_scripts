...
const serverUrl = "http://1f8d5a00d084.ngrok.io";
...
function getProduct(){
    product_id = document.querySelector('select.product-form__variants option[selected="selected"]').getAttribute('value');
    console.log(product_id + " got")

    fetch(`https://${window.location.hostname}/admin/api/2021-04/variants/${product_id}.json`,{
        method: "GET",
        headers: {
