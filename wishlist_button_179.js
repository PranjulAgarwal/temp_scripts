...
const serverUrl = "http://b41d1673b468.ngrok.io";
...
function render_heart(data){
    ...
    <div id="myModal" class="modal_wishlist">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <span class="modal-menu"><i class="fa fa-ellipsis-v" aria-hidden="true"></i></span>
          <h2>WISHLIST</h2>
        </div>
    ...
    if(wish_list.length==0){
        document.getElementById('wishlist_grid').innerHTML= `<div style=" margin: auto; text-align: center; padding: 10vh 0; ">No products were added to the wishlist. <br/> Continue Shopping !!</div>`;
        return
    }
}
                ...
                fetch(`https://${shop_name}/admin/api/2021-04/products/${productid}.json`,{
                    ...
                    res.json().then((productData)=>{
                        ...
                        const OutofStockCard = `<div class="product_card" id="${productTitle} - ${variantTitle}">
                                                ...
                                                <div id="${variantid}" style="color:" data-item="${productTitle} - ${variantTitle}" class="outofstock_btn">
                                                    OUT OF STOCK
                                                </div>
                                            </div>`;
