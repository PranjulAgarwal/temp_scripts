...
const serverUrl = "http://572940c9c795.ngrok.io";
...
for (var i = 0; i < products_catalog.length; i++) {
    const inlist_index = wish_list.indexOf(products_catalog[i].getAttribute('id'));
    if(inlist_index>-1){
...
// function renderHeartCatalog(inlist){
...
//     // }
//     // </style>
//     // <button  id="{{ product.variants[0].id }}" data-variant-name='product.title product.variants[0].title' class="button_wish_catalog"><i class="fa fa-heart-o" aria-hidden="true"></i></button>`
