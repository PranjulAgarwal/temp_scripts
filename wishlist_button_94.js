...
const serverUrl = "http://217dac58aab1.ngrok.io";
...
function add_variant(){
    ...
    fetch(`https://${window.location.hostname}/admin/api/2021-04/variants/${product_id}.json`,{
        ...
        res.json().then((variant_data)=>{
            product_db.push(JSON.stringify(variant_data));
        })
    })
...
function delete_variant(){
    ...
    fetch(`https://${window.location.hostname}/admin/api/2021-04/variants/${product_id}.json`,{
        ...
        res.json().then((variant_data)=>{
            product_db.splice(JSON.stringify(variant_data));
        })
    })
