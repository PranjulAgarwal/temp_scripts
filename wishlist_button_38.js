...
function renderButton(data) {
    ...
    init(Value,wish_button_1,wish_button_2,wish_button_3,wish_button_4,wish_button_5,wish_btn_status,data);
    
}
function init(Value,wish_button_1,wish_button_2,wish_button_3,wish_button_4,wish_button_5,wish_btn_status,data) {
//console.log("from init function")
    
//eventListeners();
    console.log({Value,wish_button_1,wish_button_2,wish_button_3,wish_button_4,wish_button_5,wish_btn_status})
        if(Value == '1')
