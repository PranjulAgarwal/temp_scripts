...
const serverUrl = "http://7136f3b61293.ngrok.io";
...
function render_heart(){
    ...
    const heart_button =  `<button><i class="fa fa-heart" aria-hidden="true"></i></button>`

    document.querySelector("div.site-header__icons-wrapper").appendChild(heart_button);
}
