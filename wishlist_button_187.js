    ...
    fetch(`https://${shop_name}/cart.js`,{
            ...
            res.json().then((cartData)=>{
                for(var i=0;i<cartData.item_count;i++){
                    cart_items.push(cartData.items[i].variant_id)
                }
