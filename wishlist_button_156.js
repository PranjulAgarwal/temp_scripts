...
const serverUrl = "http://0c2f08e7c480.ngrok.io";
...
initCss();                  //inject fa-icon js in head
render_heart();             //render heart btn in header along with wishlist models

var wish_list = [];         //list of temporarily stored varient ids
var variant_id;             //Single selected varient id
var product_db =[""];       //list of temporarily stored varient names
var variant_data = "";      //Single seleted varient name

Customer_data_call();       //call customer's wishlist or create a new one
