...
function renderButton(data) {
    ...
    console.log({wish_btn_status,color_Btn,label_Btn})
    ...
    init(Value,wish_button_1,wish_button_2,wish_button_3,wish_button_4,wish_button_5,wish_btn_status,data,color_Btn,label_Btn);
    
}
function init(Value,wish_button_1,wish_button_2,wish_button_3,wish_button_4,wish_button_5,wish_btn_status,data,color_Btn,label_Btn) {
...
//eventListeners();
    ...
    document.getElementById("wish_btn").addEventListener("click", (event) => {
        ...
        console.log(wish_btn_status)
        renderButton(data,wish_btn_status);
    });
}
