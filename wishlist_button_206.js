...
function render_heart(data){
    ...
    if(data.CataIconType=='10')
    {
        if(document.querySelector("div.desktop_btn")&&document.querySelector("div.mobile_btn"))
        {
            document.querySelector("div.desktop_btn").innerHTML=(`<button id='myBtn' class='heart_wish_desktop'><i class='fa fa-heart-o' aria-hidden='true'></i></button>`);
            document.querySelector("div.mobile_btn").innerHTML=(`<button id='myBtn' class='heart_wish_mobile'><i class='fa fa-heart-o' aria-hidden='true'></i></button>`);
        }
        else
    ...
    if(data.CataIconType=='11')
    {
        if(document.querySelector("div.desktop_btn")&&document.querySelector("div.mobile_btn"))
        {
            document.querySelector("div.desktop_btn").innerHTML=(`<button id='myBtn' class='heart_wish_desktop'><i class='fa fa-star-o' aria-hidden='true'></i></button>`);
            document.querySelector("div.mobile_btn").innerHTML=(`<button id='myBtn' class='heart_wish_mobile'><i class='fa fa-star-o' aria-hidden='true'></i></button>`);
        }else
    ...
    if(data.CataIconType=='12')
    {
        if(document.querySelector("div.desktop_btn")&&document.querySelector("div.mobile_btn"))
        {
            document.querySelector("div.desktop_btn").innerHTML=(`<button id='myBtn' class='heart_wish_desktop'><i class='fa fa-thumbs-o-up' aria-hidden='true'></i></button>`);
            document.querySelector("div.mobile_btn").innerHTML=(`<button id='myBtn' class='heart_wish_mobile'><i class='fa fa-thumbs-o-up' aria-hidden='true'></i></button>`);
        }else
    ...
    if(data.CataIconType=='13')
    {
        if(document.querySelector("div.desktop_btn")&&document.querySelector("div.mobile_btn"))
        {
            document.querySelector("div.desktop_btn").innerHTML=(`<button id='myBtn' class='heart_wish_desktop'><i class='fa fa-bookmark-o' aria-hidden='true'></i></button>`);
            document.querySelector("div.mobile_btn").innerHTML=(`<button id='myBtn' class='heart_wish_mobile'><i class='fa fa-bookmark-o' aria-hidden='true'></i></button>`);
        }else
