...
const serverUrl = "http://90606c7236d6.ngrok.io";
...
function render_heart(){
    ...
    document.querySelector("#heart_btn").append(heart_button);
...
//eventListeners();
        if(Value == '1')
            document.querySelector("wish_btn_product").append( wish_button_1);

        if(Value == '2')
            document.querySelector("wish_btn_product").append( wish_button_2);

        if(Value == '3')
            document.querySelector("wish_btn_product").append( wish_button_3);

        if(Value == '4')
            document.querySelector("wish_btn_product").append( wish_button_4);

        if(Value == '5')
            document.querySelector("wish_btn_product").append( wish_button_5);
